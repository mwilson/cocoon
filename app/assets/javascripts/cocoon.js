(function($) {
  ...
  $(document).on('click','.add_cocoon_fields', function(e) {
    e.preventDefault();
    var $this                 = $(this),
  ...
  $(document).on('click','.remove_cocoon_fields.dynamic', function(e) {
    var $this = $(this);
  ...
  $(document).on('click','.remove_cocoon_fields.existing', function(e) {
    var $this = $(this);
